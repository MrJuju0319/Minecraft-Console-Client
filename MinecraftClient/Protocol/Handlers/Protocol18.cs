...
namespace MinecraftClient.Protocol.Handlers
{
    ...
    class Protocol18Handler : IMinecraftCom
    {
        ...
        internal const int MC_1_21_8_Version = 772;
            ...
            ForgeInfo? forgeInfo)
        {
            ...
            if (handler.GetTerrainEnabled() && protocolVersion > MC_1_21_8_Version)
            {
            ...
            if (handler.GetInventoryEnabled() &&
                protocolVersion is < MC_1_8_Version or > MC_1_21_8_Version)
            {
...
#pragma warning restore CS0162 // Unreachable code detected
                ...
                case PacketTypesIn.EntityMetadata:
                    if (handler.GetEntityHandlingEnabled())
                    {
                        ...
                        {
                            > MC_1_21_8_Version => throw new NotImplementedException(Translations
